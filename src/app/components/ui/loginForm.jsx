...
const LoginForm = () => {
  ...
  //     )
  //     .matches(/(?=.{8,})/, 'Пароль должен быть не менее восьми символов'),
  //   email: yup
  //     .string()
  //     .required('Электронная почта обязательна для заполнени')
  ...
  const validatorConfig = {
    ...
    password: {
      ...
      min: {
        message: 'Пароль должен быть не менее восьми символов',
        value: 8
      }
    }
  }
